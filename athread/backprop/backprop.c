...
extern slave_spe_func1(struct spe_func1_parameter *spe_func_param);
extern slave_spe_func2(struct spe_func2_parameter *spe_func_param);
...
void bpnn_layerforward(float *l1, float *l2, float **conn, int n1, int n2)
{
  ...
  //   l2[j] = squash(sum);
  // }
  struct spe_func1_parameter spe_func_param = {
    .conn = conn,
    .l1 = l1,
    .l2 = l2,
    .n1 = n1,
  ...
  athread_spawn(spe_func1, &spe_func_param);
  athread_join();
}
...
void bpnn_adjust_weights(float *delta, int ndelta, float *ly, int nly, float **w, float **oldw)
{
  ...
  //   }
  // }
  struct spe_func2_parameter spe_func_param = {
    .delta = delta,
    .ly = ly,
    .ndelta = ndelta,
    .nly = nly,
  ...
  athread_spawn(spe_func2, &spe_func_param);
  athread_join();
}
...
void bpnn_save_human(BPNN *net, char *filename)
{
  int n1, n2, n3, i, j, memcnt;
  float dvalue, **w;
  char *mem;
